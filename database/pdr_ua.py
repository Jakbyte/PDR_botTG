...
"12.10": '''одаткові обмеження дозволеної швидкості руху можуть вводитися тимчасово і постійно.
...
сільськогосподарської техніки,
яка рухається за межами населених пунктів,
дорогами сіл, селищ, міст районного значення,                   3,75
без винесення габариту на смугу зустрічного руху

Висота від поверхні дороги:                                      4

транспортних засобів спеціалізованого
призначення (контейнеровозів), 
що здійснюють перевезення одного                                4,35
або більше контейнерів, на маршрутах,
встановлених Агентством відновлення,
Укртрансбезпекою, Національною поліцією
...
Тип транспортного засобу                         Максимальне значення для автомобільних доріг
                                            державного значення, тонн    місцевого значення, тонн
...
чотирьохвісний автомобіль з двома
рульовими вісями та ведучими вісями,                38                          24
оснащеними спареними колесами


Комбіновані транспортні засоби:


двовісний автомобіль (тягач)                        36                          24
з двовісним напівпричепом


двовісний автомобіль (тягач)                        40                          24
з трьохвісним напівпричепом

трьохвісний автомобіль (тягач)                      40                          24
з двовісним або трьохвісним напівпричепом

двовісний автомобіль (тягач) 
з трьохвісним напівпричепом (контейнеровоз),
що здійснює перевезення одного                      42                          24        
або більше контейнерів
або змінних кузовів загальною максимальною
довжиною 13,716 метра

трьохвісний автомобіль (тягач)
з двовісним або трьохвісним
напівпричепом (контейнеровоз), що здійснює 
перевезення одного або більше контейнерів           44                          24
або змінних кузовів загальною 
максимальною довжиною 13,716 метра

Автопоїзди:

двовісний або трьохвісний автомобіль                40                          24
з двовісним або трьохвісним причепом
...
від 1,3 до 1,8 метра при спарених колесах,
за умови, що навантаження на кожну                  19                           11,5
вісь не перевищує 9,5 тонни

від 1,3 до 1,8 метра чотирьохвісних
автомобілів, ведучі вісі яких оснащені
спареними колесами, за умови,                       23                           11,5
що навантаження на кожну ведучу
вісь не перевищує 11,5 тонни

від 1,8 до 2,5 метра для                            20                           11,5
причепів та напівпричепів

На строєні осі, в тому числі транспортних
засобів спеціалізованого призначення (контейнеровозів)
, що здійснюють перевезення одного або
більше контейнерів, якщо відстань між осями:
